...
class Project(models.Model):
    ...
    cover_image = models.ImageField('Imagem de capa:', max_length=255, upload_to='projects/images', blank=True)
    files = models.FileField('Arquivos do projeto:', max_length=255, upload_to='projects/files', blank=True)
    slug = models.SlugField('Identificador:', max_length=50)
    status = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
